...
// config degrades to the fallback rather than failing the bridge.
//
// Mirrors browser-connectors/chrome/native-host/src/identity.ts so every
// connector on a machine reports the same identity.
